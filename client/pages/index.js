    ...
    <HomeHeadLayout>
      ...
      {props.showBanner && (
        <motion.div
          ...
          exit="exit"
          className="flex justify-center items-center fixed left-0 right-0 bottom-0 h-auto w-full bg-banner-color text-white z-40 shadow-banner-shadow"
        >
          <p className="py-5 px-10 lg-px-0 text-sm lg:text-base">
          ...
          <motion.button
            ...
            whileHover="hover"
            whileTap="tap"
            className="mx-3 p-2 rounded-md bg-yellow-500 text-banner-color focus-within:outline-none"
