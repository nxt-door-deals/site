...
const FraudAlertText = (props) => {
  return (
    <div className="text-sm p-8 md:p-10 relative">
      ...
      <ul className="mt-7">
        <li className="pb-3">
          <FontAwesomeIcon icon={faFlag} className="error-text mr-1" />
        ...
        <li>
          <FontAwesomeIcon icon={faFlag} className="error-text mr-1" /> Even if
          someone quotes a correct flat number from one of the blocks in your
