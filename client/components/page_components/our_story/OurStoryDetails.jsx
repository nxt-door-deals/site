        ...
        <div className="flex flex-col-reverse items-center lg:flex-row lg:justify-center px-10 py-10 lg:px-44 mb-20 lg:mb-10 bg-purple-100">
          <div className="lg:flex-5">
            ...
            <p className="pt-5">
              ...
              doorstep. But how many times do we find ourselves boxing up the
              “old stuff” and shipping it to its permanent home in an attic
              somewhere to make way for the new and shiny replacement?
              Sometimes, we toss it in the trash.
            </p>
            <p className="pt-2">
              With a huge chunk of India’s urban population living in large
              apartment communities, there are potentially hundreds of
              neighbours who might be interested in the things we box up or toss
              away. With the average resident being part of a small subset of
              the hundred or so online groups in each community, posting an ad
              on these platforms is more miss than hit in finding that potential
              buyer. We aim to make this buy/sell process simpler by providing a
              dedicated marketplace for your community where you have all the
              power!
            </p>
          </div>
        ...
        <div className="flex flex-col-reverse items-center lg:flex-row lg:justify-center px-10 py-5 lg:px-44 pb-10 mb-20 bg-purple-100">
          <div className="lg:flex-5">
            ...
            <p className="pt-5">
              ...
              whatever little we can reduce pollution. Making recycling and
              reuse second nature is a small step in that direction. Every small
              stride taken towards reducing pollution of any kind, ensures a
              safer and cleaner future for our children. One of our core
              missions is to reduce recyclable waste that might end up in a
              landfill. Whether you are buying or selling a preloved item, not
              only are you helping us in this mission, but you are also doing
              your bit to save mother nature.
            </p>
          </div>
          <div className="lg:flex-2 px-5 pb-2 lg:pb-0">
            <Image
