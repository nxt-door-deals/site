...
const GoodbyeHeadLayout = (props) => {
  return (
    <Fragment>
      <CommonHeadLayout />
      <Head>
        <title>NXT Door Deals | Thanks and adieu</title>
        <meta name="description" content="Sorry to see you go." />
        <meta property="og:locale" content="en_US" />
        <meta property="og:type" content="website" />
        <meta property="og:title" content="NXT Door Deals | Thanks and adieu" />
        <meta property="og:description" content="Sorry to see you go." />
        <meta property="og:url" content="https://nxtdoordeals.com/goodbye" />
          ...
          dangerouslySetInnerHTML={{
            __html: `[
              ...
              },
              {
                ...
                "http://schema.org/potentialAction": [
                  {
                    ...
                    "http://schema.org/target": [
                      {
                        "@value": "https://nxtdoordeals.com/goodbye"
                      }
                    ]
                  }
                ],
                "http://schema.org/url": [
                  {
                    "@id": "https://nxtdoordeals.com/goodbye"
                  }
                ]
              }
            ]`,
